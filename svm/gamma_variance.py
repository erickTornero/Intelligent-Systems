...
gauss1 = TrainSVMModel(X_train, Y_train, C_=10,kindofkernel='rbf', gamma= 0.1)
gauss2 = TrainSVMModel(X_train, Y_train, C_ = 10, kindofkernel='rbf', gamma= 1)
gauss3 = TrainSVMModel(X_train, Y_train, C_= 10, kindofkernel='rbf', gamma = 10)
gauss4 = TrainSVMModel(X_train, Y_train, C_ = 10, kindofkernel='rbf', gamma= 100)

models = (gauss1, gauss2, gauss3, gauss4)

from PlotMeshSVM import get_meshgrid, plot_contours
titles = ('gamma = 0.1', 'gamma = 1', 'gamma = 10', 'gamma = 100')
Gentitle = 'Gaussian Kernell, C = 10, Vary gamma'
import matplotlib.pyplot as plt
